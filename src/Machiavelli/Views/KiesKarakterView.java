...
public class KiesKarakterView {
   ...
   * knoppen (buttons) voor elk karakter in de karakterFactory. Voordat de karakter / speler knoppen
   * worden toegevoegd wordt er eerst gekeken naar het type van de karakterController. Als het type:
   * speler, is. Dan wordt er door de lijst met spelende spelers geloopt, voor elke speler wordt een
   * button gemaakt.
   * 
  ...
  /**
   * Maakt een karakterView voor elke speler in de karakterFactory. Elke view bevat een button (met
   * karkater naam) en een image (van karakter). Elke button krijgt een eventhandler die een
   ...
   * karkater naam) en een image (van karakter) vanuit de meespelende speler. Elke button krijgt een
   * eventhandler die een toegewezen karakter (bijvoorbeeld 0, moordenaar) zet als target voor een
   * eigenschap. De view wordt in een lijst van StackPanes opgeslagen.
   * 
   * @throws RemoteException
   */
   ...
   * later dan de nieuwe pane (van de KiesKarakterView) geplaatst, zodat die onderop ligt. De nieuwe
   ...
   * Er wordt gefilterd op #kieskarakterpane (css id) om de te verwijderen pane te vinden. De pane
